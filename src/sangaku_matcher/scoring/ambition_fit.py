...
class AmbitionFitScorer:
    ...
    def score(self, seed_vector: np.ndarray, company: dict) -> FeatureResult:
        ...
        # Weighted score: sum of (normalized seed weight x company-theme z-score)
        total_score = 0.0
        total_weight = 0.0
        top_themes = []
        ...
        for i, theme in enumerate(self._themes):
            ...
            # Z-score normalize company proximity with sigmoid transform
            ...
            if company_score > 0.6:
                top_themes.append((theme["label"], company_score, raw_seed_sim, theme["humanities_role"]))
